      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="card p-12 text-center">
          <div className="w-16 h-16 mx-auto mb-5 rounded-full bg-[var(--arena-100)] flex items-center justify-center">
            <svg aria-hidden="true" className="w-8 h-8 text-[var(--tinta-3)]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2.5 text-sm text-[var(--tinta-3)]">
                <div className="w-7 h-7 rounded-lg bg-[var(--ambar-50)] flex items-center justify-center shrink-0">
                  <svg aria-hidden="true" className="w-4 h-4 text-[var(--ambar-700)]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              <div className="flex items-center gap-2.5 text-sm text-[var(--tinta-3)]">
                <div className="w-7 h-7 rounded-lg bg-[var(--ok-bg,#EDFAF3)] flex items-center justify-center shrink-0">
                  <svg aria-hidden="true" className="w-4 h-4 text-[var(--ok)]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
