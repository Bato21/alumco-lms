...
export default async function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-[#f7f9fb] font-sans text-[#2a3439]">
      {/* Desktop: grid con sidebar fijo, Mobile: solo contenido */}
      <div className="lg:grid lg:min-h-screen lg:w-full lg:grid-cols-[256px_1fr]">
