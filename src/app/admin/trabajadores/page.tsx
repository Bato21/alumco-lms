...
export default async function TrabajadoresPage(props: { searchParams: SearchParams }) {
  ...
  return (
    <>
      <header className="w-full bg-[#f7f9fb] px-8 pt-6 sticky top-0 z-40 border-b border-[#e8eff3]/50">
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-[#2B4FA0] tracking-tight">Trabajadores y Solicitudes</h2>
                  ...
                  {solicitudes.length === 0 ? (
                    ...
                    solicitudes.map((solicitud) => (
                      <tr key={solicitud.id} className="hover:bg-[#f0f4f7] transition-colors">
                        <td className="px-6 py-4 font-semibold text-[#2a3439]">{solicitud.full_name}</td>
                        <td className="px-6 py-4 text-[#566166]">{solicitud.rut || 'N/A'}</td>
                        <td className="px-6 py-4 text-[#566166]">{solicitud.email}</td>
                  ...
                  {activos.length === 0 ? (
                    ...
                    activos.map((worker) => (
                      <tr key={worker.id} className="hover:bg-[#f0f4f7] transition-colors">
                        ...
                        <td className="px-6 py-4 text-[#566166]">{worker.rut || 'N/A'}</td>
                        <td className="px-6 py-4 text-center">
