...
export default async function EditarCursoPage({ params }: EditarCursoPageProps) {
  ...
  const coursePromise = supabase
    ...
    .eq('id', id)
    .single() as unknown as Promise<{ data: { id: string; title: string; description: string | null; deadline: string | null; deadline_description: string | null; is_published: boolean; target_areas: string[] | null } | null }>
